<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login_Gfive_Login" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="../../Assets/Onida/CSS/login.css" type="text/css" runat="server" />
    ...
    <form id="form1" runat="server">
        ...
        <div id="loginwrapper">
            <div id="logincontainer">
                <div id="logintop">
                    <div class="loginlogo">
                        <img src="../../assets/Onida/css/images/logo.gif" width="182" height="55" />
                    </div>
                ...
                <div id="loginbox">
                    <div class="loginheading">Welcome to ONIDA Sales</div>
                ...
                <div id="loginfooter">
                    ...
                    <div class="loginfooterright">
                        <a href='<%= (String)ConfigurationSettings.AppSettings["RedirectUrl"] %>' target="_blank">
                            <img src="../../assets/Onida/css/images/footerlogo.gif" border="0" /></a>
                    </div>
                </div>
            </div>
        </div>
