...
<head runat="server">
    ...
    <link rel="stylesheet" href="~/Assets/VideoCon/CSS/login.css" type="text/css" />
</head>
<body>
        ...
        <div class="header">
            <div class="wrapper">
                <div class="login_header">
                    <div class="logo">
                        <img src="../../assets/VideoCon/css/images/logo.png" alt="" /></div>
                    <div class="header-right">
                        <img src="../../assets/VideoCon/css/images/logo-right.jpg" alt="" /></div>
                    <div class="clear">
                    </div>
                </div>
            </div>
    ...
    <div class="footer">
        <div class="wrapper">
            ...
            <div class="zedservicelogo">
                <img src="../../assets/VideoCon/css/images/zed-saleslogo.png" /></div>
            <div class="powerdby">
                Powered by</div>
            <div class="clear">
            </div>
