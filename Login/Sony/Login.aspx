...
<head runat="server">
    ...
    <link href="../../Assets/Sony/CSS/login.css" rel="stylesheet" type="text/css" />
    ...
    <form id="form1" runat="server">
        <div class="header">
            <div class="wrapper">
                <div class="login_header">
                    <div class="logo" style="background: url(../../assets/Sony/css/images/logo.jpg) no-repeat;">
                    </div>
                    <div class="header-right" style="background: url(../../assets/Sony/css/images/logo-right.jpg) no-repeat left 3px;">
                    </div>
                    <div class="clear">
                    </div>
                </div>
        ...
        <div id="loginwrapper">
            <div id="logincontainer">
                ...
                <div id="loginleft" style="background: url(../../assets/Sony/css/images/logincont_left.png) no-repeat center top;">
                </div>
                <div id="loginright">
                    <div id="loginbox">
                        <div class="loginhead">
                        ...
                        <div class="loginfield">
                            ...
                            <asp:TextBox ID="txtUsername" runat="server" MaxLength="30" CssClass="login_input "></asp:TextBox><asp:RequiredFieldValidator
        ...
        <div class="footer">
            <div class="wrapper">
                ...
                <div class="zedservicelogo">
                    <img src="../../assets/Sony/css/images/zed-saleslogo.png" />
                </div>
                <div class="powerdby">
                    Powered by
                </div>
