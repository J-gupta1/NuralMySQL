...
<head runat="server">
    ...
    <link href="../../Assets/Shivalik/CSS/login.css" rel="stylesheet" type="text/css" />
    ...
    <div class="wrapper-border">
        <div class="header">
            <div class="wrapper">
                <div class="login_header">
                    <div class="logo">
                        <img src="../../assets/Shivalik/css/images/logo.png" alt="" />
                    </div>
                    <div class="header-right">
                        <img src="../../assets/Shivalik/css/images/logo-right.jpg" alt="" />
                    </div>
                    <div class="clear">
                    </div>
                </div>
        ...
        <div id="loginwrapper">
            <div id="logincontainer">
                <div id="logintop">Shivalik Distribution Management System
                </div>
                <div id="loginleft">
                </div>
                <div id="loginright">
                    <div id="loginbox">
                        ...
                        <div class="errorarea">
                            ...
                            <%--#CC01 Add Start--%>
                            <span class="float-right"><span><a id="HyplkLogOut" class="linkbutton" runat="server"
                                visible="false">Logout</a></span></span>
                            <div class="clear">
                            </div>
                            <%--#CC01 Add End--%>
                        </div>
    ...
    <div class="footer">
        <div class="wrapper">
            <div class="footer-left">
                &copy; Zed-Axis Technologies 2016-17. All Rights Reserved
            </div>
            <div class="footer-center">
                Browser Compatibility: IE 7.0, 8.0 , Firefox - 4.0
            </div>
            <div class="zedservicelogo">
                <img src="../../assets/Shivalik/css/images/zed-saleslogo.png" />
            </div>
            <div class="powerdby">
                Powered by
            </div>
