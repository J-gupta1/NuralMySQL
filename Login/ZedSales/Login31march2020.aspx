...
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-11 col-sm-11 col-xs-11">
                                    <div class="form-group">
                                        <div>
                                            <asp:TextBox ID="txtUsername" runat="server" MaxLength="30" CssClass="form-control user-icon" placeholder="Enter User Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-11 col-sm-11 col-xs-11">
                                    <div class="form-group">
                                        <asp:Button Text="Submit" runat="server" ID="btnSubmit" CssClass="btn btn-login btn-block" ValidationGroup="valgrpLogin"
        ...
        <footer>
            <div class="container">
                <div>
                    &copy; 2019-20 All Rights Reserved.                 
                </div>
                <div class="clearfix"></div>
            </div>
        </footer>        
