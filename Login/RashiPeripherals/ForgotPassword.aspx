...
<head runat="server">
    ...
    <link rel="stylesheet" href="~/Assets/RashiPeripherals/CSS/login.css" type="text/css" />
</head>
<body>
    ...
    <div class="header">
        <div class="wrapper">
            <div class="login_header">
                <div class="logo">
                    <img src="../../assets/RashiPeripherals/css/images/logo.png" alt="" /></div>
                <div class="header-right">
                    <img src="../../assets/RashiPeripherals/css/images/zed_logo.png" alt="" /></div>
                <div class="clear">
                </div>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="wrapper">
            ...
            <div class="zedservicelogo">
                <a href='<%= (String)ConfigurationSettings.AppSettings["RedirectUrl"] %>' target="_blank">
                    <img src="../../assets/RashiPeripherals/css/images/zed-saleslogo.png" border="0" /></a></div>
            <div class="powerdby">
                Powered by</div>
            <div class="clear">
            </div>
