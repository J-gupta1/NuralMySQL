...
<head runat="server">
    ...
    <link href="../../Assets/RashiPeripherals/CSS/login.css" rel="stylesheet" type="text/css" />
        ...
        <div class="header">
            <div class="wrapper">
                <div class="login_header">
                    <div class="logo" style="background: url(../../assets/RashiPeripherals/css/images/logo.png) no-repeat;">
                    </div>
                    <div class="header-right">
                        <img src="../../assets/RashiPeripherals/css/images/zed_logo.png" alt="" />
                    </div>
                    <div class="clear">
                    </div>
                </div>
        ...
        <div class="footer">
            <div class="wrapper">
                ...
                <div class="zedservicelogo">
                    <a href='<%= (String)ConfigurationSettings.AppSettings["RedirectUrl"] %>' target="_blank">
                        <img src="../../assets/RashiPeripherals/css/images/zed-saleslogo.png" border="0" /></a>
                </div>
                <div class="powerdby">
                    Powered by
                </div>
