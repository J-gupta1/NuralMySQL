...
public partial class Reports_Retailer_RSPAttendanceReport : PageBase
{
        ...
        try
        {
            ...
            if (validation())
            {
                ...
                //using (TempClass objRD = new TempClass())
                {
                    ...
                    objRD.FilePath = "RSPAttendance" + strExportFileName;
                    objRD.ISPCode = ISPCode();
                    intResult = objRD.GetRSPAttendanceReport();
