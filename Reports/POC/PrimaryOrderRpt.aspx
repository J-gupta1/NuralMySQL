<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimaryOrderRpt.aspx.cs"
    Inherits="Reports_SalesChannel_PrimaryOrderRpt" MasterPageFile="~/CommonMasterPages/ReportPage.master" %>
            ...
            <div class="PivotGrid">
                <dxwpg:ASPxPivotGrid Width="100%" ID="ASPxPvtGrd" runat="server" EnableRowsCache="false">
                    ...
                    <Fields>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField6" Area="RowArea" AreaIndex="0" Caption="Order From"
                            FieldName="OrderFrom">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField7" Area="RowArea" AreaIndex="1" Caption="Order To"
                            FieldName="OrderTo">
                        </dxwpg:PivotGridField>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField8" Area="RowArea" Visible="true" AreaIndex="3"
                            Caption="Order Number" FieldName="OrderNumber">
                        </dxwpg:PivotGridField>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField17" Area="FilterArea" AreaIndex="9" Caption="Product"
                            FieldName="ProductName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField12" Area="FilterArea" AreaIndex="10" Caption="Brand"
                            FieldName="BrandName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField13" Area="FilterArea" AreaIndex="11" Caption="Model"
                            FieldName="ModelName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField14" Area="FilterArea" AreaIndex="12" Caption="Color"
                            FieldName="ColorName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField10" Area="FilterArea" AreaIndex="13" FieldName="SKUCode"
                            Caption="SKU Code ">
                        </dxwpg:PivotGridField>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField16" Area="DataArea" CellFormat-FormatType="Numeric"
                            AreaIndex="1" Caption="InvoicedQuantity" FieldName="InvoicedQuantity">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField20" Area="DataArea" CellFormat-FormatType="Numeric"
                            AreaIndex="2" Caption="Amount" FieldName="Amount">
                        </dxwpg:PivotGridField>
                    </Fields>
