...
public partial class Reports_New_Reports_RatailerOpeningStockReport : System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
            ...
            try
        {
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                Ds = obj.getRetailerOpemingStockReport();
            if ((obj.error == "") || (obj.error==null))
                ...
                string FilenameToexport = "RetailerOpeningStock Report";
