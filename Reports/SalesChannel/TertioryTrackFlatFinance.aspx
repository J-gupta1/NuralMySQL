<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="TertioryTrackFlatFinance.aspx.cs" Inherits="Reports_SalesChannel_TertioryTrackFlatFinance" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" align="left">
                                                                <asp:DropDownList ID="ddlDateType"  runat="server" CssClass="form_select4">
                                                                    <asp:ListItem Text="Finance Date" Selected="True" Value="2"></asp:ListItem>
                                                                    <asp:ListItem Text="Primary Sales Date" Value="1"></asp:ListItem>
                                                                    <asp:ListItem Text="Tertiary Considered Date" Value="3"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
