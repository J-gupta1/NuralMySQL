 ...
 *  17-Sep-2018, Balram Jha #CC14- Created copy of Stock Report for IMEI wise download.
 */

public partial class Reports_DownloadStockRptIMEI : PageBase
{
            ...
            using (ReportData objRD = new ReportData())//#CC03 added
            {
                ...
                else
                {
                    ...
                    if (strEntityTypeBaseEntityType[1] == "3")
                    {
                        ...
                        ds = objRD.GetStockReportRetailerIMEIWise(out intResult,out message);
                        if (intResult == 0)
                        {
                            ucMsg.ShowInfo(Resources.Messages.NoRecord);
                            return;
                        ...
                        else
                        {
                            ...
                            {
                                ucMsg.ShowSuccess(message);
                                return;
                            }
                            PageBase.ExportToExecl(ds, "StockRetailer");
                        }
                    }
                    else
                    {
                        ds = objRD.GetStockReportIMEIWise(out message);
    ...
    protected void fillLocations()
    {
        using (OrgHierarchyData obj = new OrgHierarchyData()) 
        {
            ...
            obj.SearchMode = 3;
            obj.UserID = PageBase.UserId; /* #CC05 Added */
