<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/ReportPage.master"
    AutoEventWireup="true" CodeFile="RetailerReachProdcat.aspx.cs" Inherits="Reports_SalesChannel_RetailerReachProdcat" %>

<%@ Register assembly="DevExpress.Web.ASPxPivotGrid.v10.1" namespace="DevExpress.Web.ASPxPivotGrid" tagprefix="dx" %>

<%----------------#CC01 vijay kumar 16/11/2017 Add distributor code--------------------------------------------------------%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="contentbox">
        <div class="H25-C4-S">
            <ul>
                ...
                <li class="field">
                    <asp:DropDownList ID="ddlProductcategory" runat="server" CssClass="formselect" AutoPostBack="true" OnSelectedIndexChanged="ddlProductcategory_SelectedIndexChanged"></asp:DropDownList>
                </li>
                ...
                <li class="field">
                    <asp:DropDownList ID="ddlModel" runat="server" CssClass="formselect"></asp:DropDownList>
                </li>
                 <%-----------#CC02 Added End-----------------------%>
                <li class="field3">
    ...
    <asp:Panel ID="pnlSearch" runat="server" Visible="false">
        ...
        <div class="contentbox">
            <div class="PivotGrid">
                <dxwpg:ASPxPivotGrid Width="100%" ID="grdRetailerReach" runat="server" EnableRowsCache="false" OptionsView-ShowHorizontalScrollBar="false">
                    <Fields>

                        <dxwpg:PivotGridField ID="PivotGridField1" Area="FilterArea" AreaIndex="0" FieldName="<%$ Resources:SalesHierarchy, HierarchyName1 %>"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName1 %>" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField9" Area="FilterArea" AreaIndex="1" FieldName="<%$ Resources:SalesHierarchy, HierarchyName2 %>"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName2 %>" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField2" Area="FilterArea" AreaIndex="2" FieldName="<%$ Resources:SalesHierarchy, HierarchyName3 %>"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName3 %>" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField3" Area="FilterArea" AreaIndex="3" FieldName="<%$ Resources:SalesHierarchy, HierarchyName4 %>"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName4 %>" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField5" Area="FilterArea" AreaIndex="4" FieldName="<%$ Resources:SalesHierarchy, HierarchyName3 %>"
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField4" Area="RowArea" AreaIndex="0" FieldName="SalesChannelName"
                            Caption="Distributer Name" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <%-----------#CC01 Added Started-----------------------%>
                        <dxwpg:PivotGridField ID="PivotDistributorcode" Area="RowArea" AreaIndex="0" FieldName="SalesChannelCode"
                            Caption="Distributer Code" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <%-----------#CC01 Added End-----------------------%>
                        
                         <%-----------#CC02 Added Started-----------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField21" Area="RowArea" AreaIndex="3" FieldName="ModelName"
                            Caption="Model Name" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField20" Area="RowArea" AreaIndex="2" FieldName="ProductCategoryName"
                            Caption="Product Category Name" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
                        <%-----------#CC02 Added End-----------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField6" Area="RowArea" AreaIndex="4" FieldName="NewRetailer"
                            Caption="New Retailer Billed" EmptyValueText="N/A">
                        </dxwpg:PivotGridField>
