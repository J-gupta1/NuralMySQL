<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseRpt.aspx.cs" MasterPageFile="~/CommonMasterPages/ReportPage.master"
    Inherits="Reports_SalesChannel_PurchaseRpt" %>
            ...
            <div class="PivotGrid">
                <dxwpg:ASPxPivotGrid Width="100%" ID="ASPxPvtGrd" runat="server" EnableRowsCache="false">
                    ...
                    <Fields>
                        ...
                        <%--   ================================#CC03 Added Vijay Kumar Prajapati================================================================--%>
                        <dxwpg:PivotGridField ID="PivotGridFieldRegion" Area="FilterArea" AreaIndex="7" EmptyValueText="N/A"
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField6" Area="RowArea" AreaIndex="5" Caption="Purchase From Name"
                            FieldName="PurchaseFromName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField7" Area="RowArea" AreaIndex="6" Caption="Purchase To Name"
                            FieldName="PurchaseToName">
                        </dxwpg:PivotGridField>

                        <%--------------------#CC01 Vijay Kumar 17/11/2017 Add from and to code----------------------------------------------------------------------%>
                        <dxwpg:PivotGridField ID="PivotGridfromcode" Area="RowArea" AreaIndex="6" Caption="Purchase To Code"
                            FieldName="PurchaseTOCode">
                        </dxwpg:PivotGridField>

                        <dxwpg:PivotGridField ID="PivotGridtocode" Area="RowArea" AreaIndex="6" Caption="Purchase From Code"
                            FieldName="PurchaseFromCode">
                        </dxwpg:PivotGridField>
                        ...
                        <dxwpg:PivotGridField ID="pvtPurchase" Area="RowArea" AreaIndex="7" Caption="Type"
                            FieldName="TYPE">
                        </dxwpg:PivotGridField>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField14" Area="DataArea" CellFormat-FormatType="Numeric"
