...
<%----------------#CC02 ,Rajnish Kumar,05/06/2018-------------------------------------%>
<%----------------#CC03 ,Vijay  Kumar Prajapati,30/07/2018-------------------------------------%>
                ...
                <dxwpg:ASPxPivotGrid Width="100%" ID="ASPxPvtGrd" runat="server" EnableViewState="false"
                    ...
                    <Fields>
                        ...
                        <dxwpg:PivotGridField ID="PivotGridField2" Area="FilterArea" AreaIndex="1" EmptyValueText="N/A"
                            FieldName="Business Head" Caption="<%$ Resources:SalesHierarchy, HierarchyName2 %>">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField3" Area="FilterArea" AreaIndex="2" EmptyValueText="N/A"
                            FieldName="Zonal Head" Caption="<%$ Resources:SalesHierarchy, HierarchyName3 %>">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField4" Area="FilterArea" AreaIndex="3" EmptyValueText="N/A"
                            FieldName="RSM" Caption="<%$ Resources:SalesHierarchy, HierarchyName4 %>">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField5" Area="FilterArea" AreaIndex="4" EmptyValueText="N/A"
                            FieldName="Branch Head" Caption="<%$ Resources:SalesHierarchy, HierarchyName5 %>">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField23" Area="FilterArea" AreaIndex="5" EmptyValueText="N/A"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName6 %>" FieldName="ASM">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField22" Area="FilterArea" AreaIndex="6" EmptyValueText="N/A"
                            Caption="<%$ Resources:SalesHierarchy, HierarchyName7 %>" FieldName="TSM">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField14" Area="FilterArea" AreaIndex="7" EmptyValueText="N/A"
                            FieldName="Country" Caption="Country">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField16" Area="FilterArea" AreaIndex="8" EmptyValueText="N/A"
                            FieldName="State" Caption="State">
                        </dxwpg:PivotGridField>
                        <%-------------#CC03 Added Started---------------------------%>
                        <dxwpg:PivotGridField ID="PivotGridFieldRegion" Area="FilterArea" AreaIndex="8" EmptyValueText="N/A"
                            FieldName="RegionName" Caption="Region">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridFieldZone" Area="FilterArea" AreaIndex="8" EmptyValueText="N/A"
                            FieldName="ZoneName" Caption="Zone">
                        </dxwpg:PivotGridField>
                        <%-------------#CC03 Added Started---------------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField6" Area="RowArea" AreaIndex="7" FieldName="SalesChannelTypeName"
                            Caption="Sales Channel Type">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField7" Area="RowArea" AreaIndex="8" FieldName="SalesChannelName"
                            Caption="Sales Channel Name">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField19" Area="RowArea" AreaIndex="8" FieldName="SalesChannelCode"
                            Caption="Sales Channel Code">
                        </dxwpg:PivotGridField>
                        <%-------------#CC01 Added Started---------------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField21" Area="RowArea" AreaIndex="8" FieldName="SalesChannelName"
                            Caption="Retailer Name">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField20" Area="RowArea" AreaIndex="8" FieldName="RetailerCode"
                            Caption="Retailer Code">
                        </dxwpg:PivotGridField>
                        <%-------------#CC01 Added End---------------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField116" Area="RowArea" AreaIndex="9" FieldName="ParentSalesChannel"
                            Caption="Parent Sales Channel">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField17" Area="RowArea" AreaIndex="10" FieldName="StockBinTypeDesc"
                            Caption="Stock Bin Type">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField18" Area="ColumnArea" AreaIndex="0" FieldName="SKUName"
                            Caption="SKU Name">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField10" Area="FilterArea" AreaIndex="9" Caption="Category"
                            FieldName="ProductCategoryName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField8" Area="FilterArea" AreaIndex="10" Caption="Product"
                            FieldName="ProductName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField11" Area="FilterArea" AreaIndex="11" Caption="Brand"
                            FieldName="BrandName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField12" Area="FilterArea" AreaIndex="12" Caption="Model"
                            FieldName="ModelName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField13" Area="FilterArea" AreaIndex="13" Caption="Color"
                            FieldName="ColorName">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField9" Area="FilterArea" AreaIndex="14" FieldName="SKUCode"
                            Caption="SKU Code">
                        </dxwpg:PivotGridField>
                        <dxwpg:PivotGridField ID="PivotGridField29" Area="FilterArea" AreaIndex="15" FieldName="CityName"
                            Caption="City Name">
                        </dxwpg:PivotGridField>
