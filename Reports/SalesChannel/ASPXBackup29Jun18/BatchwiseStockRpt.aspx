                                            ...
                                            <tr>
                                                <td align="left" valign="top" class="tableposition">
                                                 <div class="mainheading_rpt">
                                                    ...
                                                    <div class="mainheading_rpt_mid">Search</div>
                                                        ...
                                                        <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                <td valign="top" class="formtext" align="right" width="10%">
                                                                    Expiry Date:<font class="error">*</font>
                                                                </td>
                                                ...
                                                <table border="0" cellpadding="3" cellspacing="0" style="float: left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-top: 10px;">
                                                          <div style="float:left; width:135px;">   <asp:DropDownList ID="ddlExportFormat" runat="server" Style="vertical-align: middle"
                                                                ValueType="System.String" CssClass="form_select">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td width="90%">
                                                     <div class="mainheading_rpt">
                                                    <div class="mainheading_rpt_left"></div>
                                                    <div class="mainheading_rpt_mid">Batch Expiry Infomation</div>
                                                    <div class="mainheading_rpt_right"></div>
                                                                                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" valign="top" class="tableposition2" style="float: left;">
                                            <div class="contentbox2">
                                                <div class="grid1">
                                                    <dxwpg:ASPxPivotGrid Width="958" ID="ASPxPvtGrd" runat="server">
