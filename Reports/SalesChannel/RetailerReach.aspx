...
AutoEventWireup="true" CodeFile="RetailerReach.aspx.cs" Inherits="Reports_SalesChannel_RetailerReach" %>
            ...
            <div class="PivotGrid">
                <dxwpg:ASPxPivotGrid Width="100%" ID="grdRetailerReach" runat="server" EnableRowsCache="false" OptionsView-ShowHorizontalScrollBar="false">
                    <Fields>
                        ...
                        <%-----------#CC01 Added End-----------------------%>
                        <dxwpg:PivotGridField ID="PivotGridField6" Area="RowArea" AreaIndex="1" FieldName="NewRetailer"
