<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/ReportPage.master" AutoEventWireup="true" CodeFile="TerSecNodMTDReport.aspx.cs" Inherits="Reports_DashBoardDMS_TerSecNodMTDReport" %>
                                            ...
                                            <tr>
                                                <td align="left" class="tableposition">
                                                    <div class="mainheading">
                                                        Tertiary Secondary Nods MTD Sale Report</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                                          ...
                                                          <%--  <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="top" align="right" width="18%">
                                                                    MTD Reports From date:<font class="error">*</font>
                                                                </td>
                                                                <td align="left" valign="top" width="20%">
                                                                ...
                                                                <td valign="top" align="right" width="18%">
                                                                    MTD Reports as on date:<font class="error">*</font>
                                                                </td>
                                                                <td align="left" valign="top" width="20%">
                                                                    <uc2:ucDatePicker ID="ucDateTo" runat="server" ErrorMessage="To date required." ValidationGroup="vgStockRpt"
                                                                        defaultDateRange="True" RangeErrorMessage="Date should be less or equal to current date." />
