...
public partial class Reports_DashBoardDMS_RetailerMTDSaleReport : PageBase //System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                if ((obj.error == "") || (obj.error==null))
                {
                    if (Ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string FilenameToexport = "RetailerMtdReport";
