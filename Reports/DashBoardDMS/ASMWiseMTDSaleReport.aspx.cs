...
public partial class Reports_DashBoardDMS_ASMWiseMTDSaleReport : PageBase//System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                Ds = obj.getASMWiseWiseMTDReport();
            if ((obj.error == "") || (obj.error==null))
                ...
                string FilenameToexport = "ASMWiseMTDSaleReport";
