...
public partial class Reports_DashBoardDMS_RDWiseMTDReport :PageBase //System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                string FilenameToexport = "RDWiseMTDSaleReport";
