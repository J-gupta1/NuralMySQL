<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/ReportPage.master" AutoEventWireup="true" CodeFile="RetailerCategoryWiseMTDSaleReport.aspx.cs" Inherits="Reports_DashBoardDMS_RetailerCategoryWiseMTDSaleReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="mainheading">
        Retailercategorywise MTD Sale Report
    </div>
    <div class="contentbox">
        ...
        <div class="H30-C3-S">
            ...
            <ul>
                ...
                <li class="text">MTD Reports as on date:<span class="error">*</span>
                </li>
                <li class="field">
                    <uc2:ucDatePicker ID="ucDateTo" runat="server" ErrorMessage="To date required." ValidationGroup="vgStockRpt"
                        defaultDateRange="True" RangeErrorMessage="Date should be less or equal to current date." />
