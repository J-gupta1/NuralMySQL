...
public partial class Reports_DashBoardDMS_PriceBandWiseMTDReport : PageBase//System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                Ds = obj.getPriceBandWiseMTDReport();
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                string FilenameToexport = "PriceBandWiseMTDSaleReport";
