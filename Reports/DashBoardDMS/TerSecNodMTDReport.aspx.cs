...
public partial class Reports_DashBoardDMS_TerSecNodMTDReport : System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                Ds = obj.getTertiarySecondaryNodReport();
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                string FilenameToexport = "TertiarySecondaryNodMTDSaleReport";
