...
public partial class Reports_DashBoardDMS_RetailerCategoryWiseMTDSaleReport :PageBase //System.Web.UI.Page
{
    DataTable dt;
    DataSet Ds;
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (ReportData obj = new ReportData())
            {
                ...
                Ds = obj.getRetailerCategoryWiseMTDReport();
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
               ...
               // dtcopy.Tables[1].AcceptChanges();
                ...
                string FilenameToexport = "RetailerCategoryWiseMTDSaleReport";
