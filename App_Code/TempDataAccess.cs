 ...
 */
    ...
    public class TempDataAccess : IDisposable
    {


        private static TempDataAccess _instance;
        Int32 intReturn;
        DataSet _dtset;
        ...
        public static TempDataAccess Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new TempDataAccess();
                }
                return _instance;
            }
        }

        private TempDataAccess()
        {
