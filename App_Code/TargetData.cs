 ...
 * 22-May-2018, Sumit Maurya, #CC01, Userid provided to get data according to user and try catch block added .(Done for motorola).
 */
using System;
...
namespace DataAccess
{
    public class TargetData : IDisposable
    {
        ...
        public void UploadTarget(DataTable Dt)
        {
            try
            {
                    SqlParam = new SqlParameter[7]; /* #CC02 Length increased from 4 - 5 */
                    ...
                    SqlParam[5] = new SqlParameter("@TargetFrom", TargetFrom);
                    SqlParam[6] = new SqlParameter("@TargetTo", TargetTo);
        ...
        public DataTable GetTargetInfo()
        {
            try
            {
                SqlParam = new SqlParameter[9]; /* #CC03 length increased From 6 to 7 */
        ...
        public DataTable GetTargetLevelUser()
        {
            try
            {
                SqlParam = new SqlParameter[5]; /* #CC01 Length increased from 4 to 5  */
                ...
                SqlParam[0] = new SqlParameter("@Userid", UserId); /* #CC01 Added */
        ...
        public DataTable GetTSIList()
        {
            try
            {
                ...
                dtTarget = DataAccess.Instance.GetTableFromDatabase("GetTSIList", CommandType.StoredProcedure, SqlParam);
                ErrorMessage = Convert.ToString(SqlParam[3].Value);
                return dtTarget;
            }
            catch (Exception ex)
            {
