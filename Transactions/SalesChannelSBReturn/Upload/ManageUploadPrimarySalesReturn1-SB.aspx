<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageUploadPrimarySalesReturn1-SB.aspx.cs" Inherits="Transactions_SalesChannelSBReturn_ManageUploadPrimarySalesReturn1_SB" %>
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">       
            ...
            <ul>
               ...
               <li class="link">
                    <a class="elink2" href="../../../Excel/Templates/PrimarySales1ReturnSB.xlsx">Download Template</a>
                 </li>
                <li class="link">
