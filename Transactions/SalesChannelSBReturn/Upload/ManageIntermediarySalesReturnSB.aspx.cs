 ...
 * 02-Aug-2018, Sumit Maurya, #CC01, Page post back added to clear fields (Done For Comio)
 * 
 */

public partial class Transactions_SalesChannelSBReturn_Upload_ManageIntermediarySalesReturnSB : PageBase
{
        ...
        try
        {
            ...
            if (ViewState["TobeUploaded"] != null)
            {
                ...
                using (SalesData objSecondary = new SalesData())
                {
                    ...
                    intResult = objSecondary.InsertIntermediarySalesReturnSB(Tvp);
    ...
    {
        Response.Redirect("ManageIntermediarySalesReturnSB.aspx"); /* #CC01 Added */
        /* ClearForm();  #CC01 Commented */
