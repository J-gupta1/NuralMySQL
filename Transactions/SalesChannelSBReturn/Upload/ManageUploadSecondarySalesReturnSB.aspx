<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageUploadSecondarySalesReturnSB.aspx.cs" Inherits="Transactions_SalesChannelSBReturn_Upload_ManageUploadSecondarySalesReturnSB" %>
                ...
                <li class="field">
                    ...
                    <div>
                        <asp:RequiredFieldValidator ID="reqStockBinType" ControlToValidate="ddlStockBinType"
                            CssClass="error" ValidationGroup="Save" InitialValue="0" runat="server" ErrorMessage="Please Select Stock Bin Type."></asp:RequiredFieldValidator>
                    </div>
                </li>                
            </ul>
            <ul>
                ...
                <li class="link">
                    <a class="elink2" href="../../../Excel/Templates/SecondarySalesReturn-SB.xlsx">Download Template</a>
                </li>
                <li class="link">
        ...
        <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div runat="server" id="dvUploadPreview" visible="false">
                    ...
                    <div class="float-right" style="width: 260px;">
