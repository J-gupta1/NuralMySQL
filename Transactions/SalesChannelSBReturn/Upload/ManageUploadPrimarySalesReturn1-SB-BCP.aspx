<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageUploadPrimarySalesReturn1-SB-BCP.aspx.cs" Inherits="Transactions_SalesChannelSBReturn_Upload_ManageUploadPrimarySalesReturn1_SB_BCP" %>
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">
                ...
                <li class="field3">
                    <div class="float-margin">
                        <asp:Button ID="btnUpload" CssClass="buttonbg" runat="server" Text="Upload" TabIndex="11"
                            OnClick="btnUpload_Click" CausesValidation="true" ValidationGroup="Add" />
                    </div>
           ...
           <div class="clear"></div>
            ...
            <ul runat="server" id="Tr1" visible="true">
                ...
                <li class="field">
                    <div>
                        <asp:DropDownList ID="ddlTemplate" runat="server" CssClass="formselect"
        ...
        <div class="formlink">
            <ul>
                ...
                <li>
                    <a class="elink2" href="../../../Excel/Templates/PrimarySales1ReturnSB.xlsx"
                        id="lnkFullTemplate" runat="server">Download Template</a>
               
                    <a class="elink2" href="../../../Excel/Templates/SalesReturnExistInSystem.xlsx"
                        id="lnkTemplateSystemExist" runat="server">Download Template System Exist</a>
                </li>
                <li>
                ...
                <div runat="server" id="dvUploadPreview" visible="false">
                    ...
                    <div class="contentbox">
                        <div class="float-right" style="width: 350px;">
                            ...
                            <div class="float-margin">
                                <asp:Button ID="btnSave1" CssClass="buttonbg"
                                    runat="server" Text="Save" ValidationGroup="Add" CausesValidation="true" OnClick="Btnsave_Click" />
                            </div>
                            <div class="float-left">
