<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageIntermediarySalesReturnSB.aspx.cs" Inherits="Transactions_SalesChannelSBReturn_Upload_ManageIntermediarySalesReturnSB" %>
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">
            ...
            <ul>
                ...
                <li class="link">
                    <a class="elink2" href="../../../Excel/Templates/IntermediarySalesReturn-SB.xlsx">Download Template</a>
                </li>
                <li class="link">
        ...
        <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div runat="server" id="dvUploadPreview"
                    ...
                    <div class="float-right" style="width: 290px;">
