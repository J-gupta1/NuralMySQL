<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master" CodeFile="ManageUploadIntermediarySales-SB-BCP.aspx.cs" Inherits="Transactions_SalesChannelSB_Upload_ManageUploadIntermediarySales_SB_BCP" %>
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">
            <ul>
                ...
                <li class="field">
                    <asp:RadioButtonList ID="rdModelList" CssClass="radio-rs" runat="server" TextAlign="Right" RepeatDirection="Horizontal"
        ...
        <div class="formlink">
            <ul>
                ...
                <li>
                    <a class="elink2" href="../../../Excel/Templates/IntermediarySales-SB.xlsx">Download Template</a>
                </li>
                <li>
