<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master" CodeFile="ManageUploadPrimarySales1-SB-BCP_V1.aspx.cs" Inherits="Transactions_SalesChannelSB_Upload_ManageUploadPrimarySales1_SB_BCP" %>
            ...
            <ul>
                <li>
                    ...
                    <asp:RadioButtonList ID="rdModelList" runat="server" CssClass="radio-rs" TextAlign="Right" RepeatDirection="Horizontal"
                        CellPadding="2" CellSpacing="0" BorderWidth="0" AutoPostBack="True" Visible="false"
                ...
                <li class="link">
                    <asp:LinkButton ID="DwnldTemplate" runat="server" Text="Download Template"
                        CssClass="elink2" OnClick="DwnldTemplate_Click"></asp:LinkButton>
                </li>
                <li class="link">
                    <%--<a class="elink2" href="../../../Excel/Templates/PrimarySales1-SB.xlsx">
                                                Download Template</a>--%>
