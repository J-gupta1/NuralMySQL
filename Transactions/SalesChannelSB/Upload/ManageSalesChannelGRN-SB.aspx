<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageSalesChannelGRN-SB.aspx.cs" Inherits="Transactions_SalesChannelSB_ManageSalesChannelGRN_SB" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/UserControls/ucMessage.ascx" TagName="ucMessage" TagPrefix="uc1" %>
<%--<%@ Register Src="~/UserControls/ucMessageCopy.ascx" TagName="ucMessage" TagPrefix="uc9" %>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <asp:UpdatePanel ID="updmsg" runat="server" UpdateMode="always">
        ...
        <uc1:ucMessage ID="ucMsg1" runat="server" />         
        </div>
