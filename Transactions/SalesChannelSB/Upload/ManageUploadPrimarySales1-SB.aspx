<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageUploadPrimarySales1-SB.aspx.cs" Inherits="Transactions_SalesChannelSB_ManageUploadPrimarySales1_SB" %>
                            ...
                            <div class="contentbox">
                                ...
                                <div class="H25-C3-S">                                    
                                    <ul>                                        
                                        ...
                                        <li class="text">
                                            Upload File: <span class="error">*</span>
                                        </li>
                                        <li class="field">
                                            <div>
                                ...
                                <div runat="server" id="dvUploadPreview" visible="false">
                                    ...
                                    <div class="float-right" style="width: 240px;">
                                        <div class="float-margin">
                                            <asp:Label ID="lblTotal" runat="server" Visible="false" Text="" Font-Bold="true"></asp:Label></div>
                                        <div class="float-margin">
