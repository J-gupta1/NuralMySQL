 ...
 * 19 June 2018,Vijay Kumar Prajapati,#CC03,Disable radiobutton list for orgnationhierarchy login.
 * 20-Sept-2018,Vijay Kumar Prajapati,#CC04,Get Error message in Export to excel (done for Karbonn).
 */
public partial class Transactions_SalesChannelSB_Upload_ManageSecondarySales_SB_BCP : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (PageBase.SalesChanelID == 0)
            {
                rdModelList.Items[1].Attributes.CssStyle.Add("visibility", "hidden");
            }
            /*#CC03 Added End*/
    ...
    protected void Btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["TobeUploaded"] != null)
            {
                ...
                DsExcelDetail.Tables[0].Columns.Add(AddColumn("6", "TransType", typeof(System.Int32)));
                ...
                using (SalesData objP1 = new SalesData())
                {
                    ...
                    if (objP1.ErrorDetailXML != null && objP1.ErrorDetailXML != string.Empty)
                    {
                        ...
                        /*#CC04 Added End */
                       // ucMsg.XmlErrorSource = objP1.ErrorDetailXML;/*#CC04 Commented*/
                        return;
                    }
        ...
        try
        {
            ...
            using (SalesChannelData objSalesData = new SalesChannelData())
            {
                ...
                if (dsTemplateCode != null && dsTemplateCode.Tables.Count > 0)
                {
                    ...
                    PageBase.RootFilePath = FilePath;
                    string[] strExcelSheetName = { "SalesFromCode", "SalesToCode", "SkuCodeList","TallyItemList","BatchCodeList" };
    ...
    public bool BulkCopyUpload(DataTable dtTempTable)
    {
        try
        {
            using (SqlBulkCopy bulkCopy = new SqlBulkCopy(PageBase.ConStr, SqlBulkCopyOptions.KeepIdentity))
            {
                ...
                bulkCopy.ColumnMappings.Add("RetailerCode", "ToCode");
