<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master" CodeFile="UploadPSIInfo.aspx.cs" Inherits="Transactions_SapIntegration_UploadPSIInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">
            ...
            <ul>
                <li class="link">
                    <a class="elink2" href="../../Excel/Templates/PSIInfo.xlsx">Download Template</a>
                </li>
                ...
                <li class="link">
                     <asp:LinkButton ID="DwnldBinCode" runat="server" Text="Download Bin Code"
                        CssClass="elink2" OnClick="DwnldBinCode_Click" ></asp:LinkButton>
                </li>
