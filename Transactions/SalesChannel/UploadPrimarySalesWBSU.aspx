<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadPrimarySalesWBSU.aspx.cs" MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Transactions_SalesChannel_UploadPrimarySalesWBSU" %>
                                    ...
                                    <ContentTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <%--    <td class="formtext" valign="top" align="left" width="10%" height="35">
                                                               ...
                                                               <%-- <td width="20%" align="left" valign="top" class="formtext" style="margin-top: -7px;
                                                                    float: left;">
