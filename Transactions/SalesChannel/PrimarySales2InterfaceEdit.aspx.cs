...
public partial class Transactions_SalesChannel_PrimarySales2Interface : PageBase
{
    ...
    //    {
    //        Response.Redirect("UploadPrimarySales2.aspx");
    //    }
    //   // updMain.Update();
    //}
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            using (SalesData objSales = new SalesData())
            {
                ...
                DataSet dsSales = objSales.GetPrimarySales2Edit();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (SalesData ObjSales = new SalesData())
            {
                ...
                ObjSales.InsertPrimarySales2InfoEdit(DtDetail);
    ...
    //        lblValidationDays.Visible = false;
