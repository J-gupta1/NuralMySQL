<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimarySalesInterfaceForEdit.aspx.cs" MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Transactions_SalesChannel_PrimarySalesInterface" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
  ...
  <tr>
    <td   valign="top" align="right" class="formtext" width="48%">
                                           <asp:Label ID="lblInvoiceDate" runat="server" Text="Invoice Date" Visible="false" ></asp:Label><font class="error">*</font></td>
     <td  valign="top" align="left" width="52%">
                                                    <uc2:ucDatePicker ID="ucDatePicker"  runat="server" ErrorMessage="Invalid date." Visible="false" defaultDateRange="true"
                                                     ValidationGroup="Add" />
                                                     <asp:Label ID="lblValidationDays" runat="server" Text="" CssClass="error" Visible="false" ></asp:Label>
                                                </td>
  </tr>
   </asp:Panel>
</table>
