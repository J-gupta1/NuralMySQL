<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimarySalesReturnUploadNew.aspx.cs" 
Inherits="Transactions_SalesChannel_PrimarySalesReturnUploadNew"  MasterPageFile="~/CommonMasterPages/MasterPage.master"%>
                                ...
                                <tr>
                                    <td align="left" valign="top" class="tableposition">
                                        <div class="mainheading">
                                            Upload <asp:Label ID="lblMainHeading" runat="server" Text="Upload Primary Sales 1 Return"></asp:Label></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" align="left" colspan="4">
                                                    ...
                                                    <a class="elink2" href="../../Excel/Templates/PrimarySalesReturnP1.xlsx">Download Template</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
