<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimarySales2InterfaceAdd.aspx.cs"
    MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Transactions_SalesChannel_PrimarySales2Interface" %>
                                ...
                                <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="25%" valign="top" align="left" class="formtext">
                                            <asp:DropDownList ID="ddlTD" runat="server" AutoPostBack="true" CssClass="form_select"
                                                OnSelectedIndexChanged="ddlTD_SelectedIndexChanged">
                                            </asp:DropDownList>
