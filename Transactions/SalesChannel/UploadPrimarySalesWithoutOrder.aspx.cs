...
public partial class Transactions_SalesChannel_UploadPrimarySales : PageBase
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (UploadCheck == 1)
            {
                ...
                isSuccess = UploadFile.uploadValidExcel(ref dsPrimarySales, "PrimarySalesWithoutOrder");
                ...
                switch (isSuccess)
                {
                    ...
                    case 2:
                        ...
                        GridSales.Columns[6].Visible = true;
    ...
    private void InsertData(DataSet dsPrimarySales)
    {
        ...
        for (int i = 0; i <= dtPrimarySales.Rows.Count - 1; i++)
        {
            if (dtPrimarySales != null && dtPrimarySales.Rows.Count > 0)
            {
                ...
                //    {
                //        dtPrimarySales.Rows[i]["Error"] = Resources.Messages.ValidationSalesDays.Replace("Number",PageBase.NumberofBackDaysAllowed.ToString().Replace("-",""));
                //    }
                //    else
                //        dtPrimarySales.Rows[i]["Error"] += Resources.Messages.ValidationSalesDays.Replace("Number", PageBase.NumberofBackDaysAllowed.ToString().Replace("-", ""));
    ...
    private void hideUnhideControls(DataTable dtPrimarySales)
    {
        ...
        if (counter == 0)
        {
            ...
            GridSales.Columns[6].Visible = false;
    ...
    protected void Btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["Sales"] != null)
            {
                ...
                {
                    Tvp = ObjCommom.GettvpTablePrimarySalesNewWitoutOrder();   //Pankaj dhingra
                }
                ...
                foreach (DataRow dr in dtPrimarySales.Rows)
                {
                    ...
                    drow[6] = dr["WarehouseCode"].ToString();       //Pankaj dhingra
                    Tvp.Rows.Add(drow);
                }
                Tvp.AcceptChanges();
                using (SalesData objPrimarySales = new SalesData())
                {
                    ...
                    objPrimarySales.SalesChannelID = PageBase.SalesChanelID;        //Pankaj Dhingra For mapping check in procedure
                    intResult = objPrimarySales.InsertPrimarySalesInfo(Tvp);
    ...
    protected void rdModeList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("PrimarySalesInterfaceWithoutOrder.aspx");
        }
    }
}
