<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="PrimarySales1ReturnInterface.aspx.cs" Inherits="Transactions_SalesChannel_PrimarySales1ReturnInterface" %>
                                ...
                                <tr>
                                    <td align="left" valign="top" class="tableposition">
                                        <div class="mainheading">
                                            Primary Sales1 Return Interface</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <div class="contentbox">
                                <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top" class="formtext" style="margin-top: -7px;">
                                    ...
                                    <tr>
                                        <td width="15%" valign="top" align="right" class="formtext">
                                            Select
                                            <asp:Label ID="lblChange" runat="server"></asp:Label>: <font class="error">*</font>
                                        </td>
                                        ...
                                        <td width="22%" valign="top" align="left" class="formtext">
                                         <%--   <br />--%>
                                        ...
                                        <td width="12%" align="right" valign="top" class="formtext">
                                        ...
                                        <td align="left" valign="top" colspan="3">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <asp:Panel ID="PnlHide" runat="server" Visible="false">
                                                    <tr>
                                                        <td align="right" valign="top" width="30%" class="formtext">
                                                            Invoice Date:<font class="error">*</font>
                                                        </td>
                                                        <td align="left" valign="top" width="70%" style="padding-top: 4px;">
                                                            ...
                                                            <uc2:ucDatePicker ID="lblInvoiceDate" runat="server" ErrorMessage="Invalid date."
                                                                defaultDateRange="true" ValidationGroup="Add" />
                                                        </td>
                                                    </tr>
                                                </asp:Panel>
                                            </table>
                                ...
                                <table id="tblGrid" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left" class="tableposition">
                                            <div class="mainheading">
                                                Enter Primary Sales 1 Interface Details
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
