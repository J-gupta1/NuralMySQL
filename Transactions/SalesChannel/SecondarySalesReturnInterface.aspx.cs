...
public partial class Transactions_SalesChannel_SecondarySalesReturnInterface :PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Convert.ToDateTime(SalesChannelOpeningStockDate).AddDays(-BackDaysAllowedBeforeOpening) >= Convert.ToDateTime(dt.AddDays(PageBase.NumberofBackDaysAllowed)))
            {
                ...
                ucReturnDate.MinRangeValue = Convert.ToDateTime(SalesChannelOpeningStockDate).AddDays(-PageBase.BackDaysAllowedBeforeOpening);
    ...
    protected void rdoSelectMode_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("UploadSecondarySalesReturn.aspx");
        }
