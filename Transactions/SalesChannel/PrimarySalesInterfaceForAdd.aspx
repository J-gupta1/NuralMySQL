<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimarySalesInterfaceForAdd.aspx.cs" MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Transactions_SalesChannel_PrimarySalesInterfaceForAdd" %>
                            ...
                            <div class="contentbox">
                                        ...
                                        <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                            ...
                                            <td width="18%"   valign="top" align="right" class="formtext">
                                                ...
                                                <div style="float: left; width: 135px;"> <asp:DropDownList ID="ddlWarehouse" 
                                                        runat="server"  CssClass="form_select" onselectedindexchanged="ddlWarehouse_SelectedIndexChanged" 
  ...
  <tr>
    <td   valign="top" align="right" class="formtext" width="48%">
     ...
     <td  valign="top" align="left" width="52%">
                ...
                <asp:Button ID="BtnSubmit" runat="server" Text="&nbsp;Add&nbsp;" CssClass="buttonbg" CausesValidation="true" ValidationGroup="EntryValidation" onclick="BtnSubmit_Click" />
