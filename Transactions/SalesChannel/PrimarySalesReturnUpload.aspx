<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrimarySalesReturnUpload.aspx.cs"
    MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Transactions_SalesChannel_PrimarySalesReturnUpload" %>
                                ...
                                <tr>
                                    <td align="left" valign="top" class="tableposition">
                                        <div class="mainheading">
                                            Upload <asp:Label ID="lblMainHeading" runat="server" Text="Upload Primary Sales 1/Primary Sales 2 Return"></asp:Label></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <ContentTemplate>
                                        <table border="0" cellpadding="4" cellspacing="0" width="100%">
                                            ...
                                            <div id="dvHide" runat="server" visible="false">
                                                <tr>
                                                    <td class="formtext" valign="top" align="right" width="10%" height="25">
                                                        Select Mode:<font class="error">*</font>
                                                    </td>
                                                    <td align="left" valign="top" width="90%" colspan="4" class="formtext">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" align="left" colspan="4">
                                                    ...
                                                    <a class="elink2" href="../../Excel/Templates/PrimarySalesReturn.xlsx">Download Template</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                ...
                                <div class="contentbox">
                                    <div class="grid1">
                                        <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridSalesReturn" runat="server" AutoGenerateColumns="true" CellPadding="4"
