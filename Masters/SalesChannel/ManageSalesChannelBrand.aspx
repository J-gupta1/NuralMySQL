<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ManageSalesChannelBrand.aspx.cs" Inherits="Masters_SalesChannel_ManageSalesChannelBrand" %>
        ...
        <ContentTemplate>
            <div>
                ...
                <div class="contentbox">
                    ...
                    <div class="H25-C3-S">
                        <ul>
                            <li class="text">Brand Name:<span class="error">*</span>
                            </li>
                            <li class="field">
                                <div>
                                    <asp:DropDownList CausesValidation="true" ID="ddlBrand" runat="server" CssClass="formselect">
                                    </asp:DropDownList>
                                </div>
                                <div>
                                    <asp:RequiredFieldValidator ID="ReqUserGroup" runat="server" ControlToValidate="ddlBrand"
                                        CssClass="error" Display="Dynamic" InitialValue="0" ErrorMessage="Please select Brand."
                            ...
                            <asp:GridView ID="grdSalesChannelList" runat="server" FooterStyle-VerticalAlign="Top"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Select">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBrandId" runat="server" Text='<%# (DataBinder.Eval(Container.DataItem,"BrandID"))%>'
