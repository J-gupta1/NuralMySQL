<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="UpdateSalesChannel.aspx.cs" Inherits="Masters_HO_SalesChannel_UpdateSalesChannel"
    ...
    <div class="contentbox">
        ...
        <div class="H35-C3-S">
            ...
            <ul>
                ...
                <li class="field">
                    <div>
                        <asp:DropDownList ID="cmborghierarchy" runat="server" CssClass="formselect" ValidationGroup="Add" Visible="True">
                            <asp:ListItem Selected="True" Value="0" Text="Select"></asp:ListItem>
                        </asp:DropDownList>
