...
/*16-April-2020,Vijay Kumar Prajapati,#CC03,Added CompanyId in Method*/
public partial class Masters_HO_Admin_BulkUploadMapping : PageBase
{
        ...
        try
        {
            ...
            if (Convert.ToInt32(ddlSaleChannelMappingType.SelectedValue) > 0 && Convert.ToInt32(ddlSaleChannelRelationType.SelectedValue) > 0)
            {
                ...
                {/* #CC01 Add Start */
                    ...
                    objSalesData.CompanyId = PageBase.ClientId;/*#CC03 Added*/
    ...
    public void BindddlMappingType()
    {
        try
        {
            ...
            objsales.CompanyId = PageBase.ClientId;/*#CC03 Added*/
            /* #CC01 Add End */
            ...
            if (ds != null)
            {
                ...
                {
                    ddlSaleChannelMappingType.Items.Insert(0, new ListItem("0", "Select"));
                }
                /*#CC02 Added End*/
            }
        }
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (UploadCheck == 1)
            {
                ...
                isSuccess = UploadFile.uploadValidExcelRetailerWithCompanyId(ref objDS, "BulkUploadMappingParentToChild");/*#CC03 Added Create new method uploadValidExcelRetailerWithCompanyId insteade of uploadValidExcelRetailer*/
