<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageAreaUpload.aspx.cs" Inherits="Masters_Common_ManageAreaUpload" %>
    ...
    <div class="contentbox">
        ...
        <div class="formlink">
            <ul>
                ...
                <li id="dvSaveTemplate">
                    <a class="elink2" href="../../Excel/Templates/AreaUpload.xlsx">Download Template</a>
                </li>
                <%-- Add End --%>
            </ul>
        </div>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridUpload" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="AreaCode"
                                                         ...
                                                         <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="TehsilName"
                                                            HeaderText="Tehsil">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
