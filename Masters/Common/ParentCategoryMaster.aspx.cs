...
public partial class Masters_Common_ParentCategoryMaster : PageBase
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        using (clsEntityMappingTypeRelationMaster objSave = new clsEntityMappingTypeRelationMaster())
        {
            ...
            objSave.ParentCategoryName = txtParentCategoryName.Text.Trim();
            ...
            {
                objSave.ParentCategoryId = Convert.ToInt32(ViewState["ParentCategoryId"]);
                objSave.Condition = 1;
            }
            objSave.SaveParentCategoryMaster();
    ...
    protected void btnSearch_Click(object sender, System.EventArgs e)
    {
        try
        {
            if (Convert.ToInt32(ddlCategoryForSearch.SelectedValue) == 255  && txtParentCategoryName.Text.Trim() == "")
            {
    ...
    protected void Exporttoexcel_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            using (clsEntityMappingTypeRelationMaster objGet = new clsEntityMappingTypeRelationMaster())
            {
                ...
                objGet.PageIndex = -1;
                objGet.ParentCategoryName = txtParentCategoryName.Text.Trim();
                objGet.CategoryForId = Convert.ToInt32(ddlCategoryForSearch.SelectedValue);
                objGet.CompanyId = PageBase.ClientId;
                dt = objGet.GetParentCategoryMasterData();
            }
            DataSet ds = new DataSet();
            ds.Merge(dt);
            string FilenameToexport = "ParentCategoryMasterDetails";
        ...
        try
        {
            if (e.CommandName.Equals("edit"))
            {
                using (clsEntityMappingTypeRelationMaster objGet = new clsEntityMappingTypeRelationMaster())
                {
                    ...
                    objGet.PageIndex = 1;
                    objGet.CompanyId = PageBase.ClientId;
                    objGet.ParentCategoryId = Convert.ToInt32(e.CommandArgument);
                    ViewState["ParentCategoryId"] = Convert.ToInt32(e.CommandArgument);
                    DataTable dt = objGet.SelectParentCategoryMasterBYID();
                    ...
                    txtParentCategoryName.Text = dt.Rows[0]["ParentCategoryName"].ToString();
    ...
    protected void grdvList_RowEditing(object sender, System.Web.UI.WebControls.GridViewEditEventArgs e)
    {

    }
    protected void grdvList_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
    ...
    private void BindList(int index)
    {
        try
        {
            ...
            using (clsEntityMappingTypeRelationMaster objGet = new clsEntityMappingTypeRelationMaster())
            {
                ...
                objGet.CategoryForId = Convert.ToInt32(ddlCategoryForSearch.SelectedValue);
                objGet.CompanyId = PageBase.ClientId;
                DataTable dt = objGet.GetParentCategoryMasterData();
