<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ManageBillingPrice.aspx.cs" Inherits="Masters_HO_Common_ManageBillingPrice" %>
            ...
            <ContentTemplate>
                ...
                <div class="H25-C3-S">
                    ...
                    <ul>
                        ...
                        <li class="link">
                            <a class="elink2" href="../../Excel/Templates/PriceBillingMasters.xlsx">Download Template</a>
                        </li>
                    </ul>
                </div>
            </ContentTemplate>
    ...
    <asp:Panel ID="pnlGrid" Visible="true" runat="server">
        <asp:UpdatePanel ID="updGrid" runat="server">
            <ContentTemplate>
                ...
                <div class="contentbox">
                    <div class="grid1">
                        <asp:GridView ID="gvPrice" runat="server" AutoGenerateColumns="true" FooterStyle-VerticalAlign="Top"
