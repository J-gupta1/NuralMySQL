<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="CustomManagePrice.aspx.cs" Inherits="Masters_HO_Common_CustomManagePrice" %>
            ...
            <ContentTemplate>
                ...
                <div class="H25-C3-S">
                    ...
                    <ul>
                        ...
                        <li class="link">
                            <a class="elink2" href="../../Excel/Templates/CustomPriceTemplate.xlsx">Download Template</a>
                        </li>
                    </ul>
                </div>
            </ContentTemplate>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvPrice" runat="server" AutoGenerateColumns="false" FooterStyle-VerticalAlign="Top"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="SDBillingPrice"
                                    HeaderText="SD Price" DataFormatString="{0:n}">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="BillingPricetoDist"
                                    HeaderText="MD Price" DataFormatString="{0:n}">
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="BasicpriceforDealer"
