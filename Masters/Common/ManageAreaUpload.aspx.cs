 ...
 * Description : Uploading(Add/Edit) Area Records from Excel Sheet.
 * ================================================================================================
 * Change Log: 
 * ------------- 
...
public partial class Masters_Common_ManageAreaUpload : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ucMsg.Visible = false;
            //#CC01 //#CC01 pnlGrid.Visible = false;
        }
    }
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (UploadCheck == 1)
            {
                ...
                isSuccess = UploadFile.uploadValidExcel(ref dsUpload, "AreaUpload");
                ...
                switch (isSuccess)
                {
                    ...
                    case 2:
                        ...
                        //#CC01 //#CC01 pnlGrid.Visible = true;
    ...
    protected void DwnldReferenceCode_Click(object sender, EventArgs e)
    {
        ...
        {
            DataSet dsReferenceCode = obj.DownloadRefCodeExcel(1);
            if (dsReferenceCode != null && dsReferenceCode.Tables.Count > 0)
            {
                try
                {
                    DataSet dtcopy = new DataSet();
                    dtcopy.Merge(dsReferenceCode.Tables[0]);
        ...
        try
        {
            ...
            for (int i = 0; i <= dtUpload.Rows.Count - 1; i++)
            {
                if (dtUpload != null && dtUpload.Rows.Count > 0)
                {
                    ...
                    string strColName1 = "AreaName = '" + dtUpload.Rows[i]["AreaName"].ToString().Trim() + "'";
                    ...
                    if (dr1.Length > 1)
                    {
                        ...
                        {
                            dtUpload.Rows[i]["Error"] = "AreaName " + Resources.Messages.UniqeMsg;
                        }
                        else
                            dtUpload.Rows[i]["Error"] += ";AreaName " + Resources.Messages.UniqeMsg;
                    }
                    ...
                    string strColName2 = "AreaCode = '" + dtUpload.Rows[i]["AreaCode"].ToString().Trim() + "'";
                    ...
                    if (dr2.Length > 1)
                    {
                        ...
                        if (dtUpload.Rows[i]["Error"].ToString() == "" && dtUpload.Rows[i]["Error"].ToString() == string.Empty)
                        {
                            dtUpload.Rows[i]["Error"] = "AreaCode " + Resources.Messages.UniqeMsg;
                        }
                        else
                            dtUpload.Rows[i]["Error"] += ";AreaCode " + Resources.Messages.UniqeMsg;
                    }
    ...
    //        //#CC01 GridUpload.Columns[6].Visible = false;
    //        ucMsg.Visible = false;
    //    }

    //    else
    //    {
    //        //#CC01 GridUpload.Columns[6].Visible = true;
    //        ucMsg.Visible = true;
        ...
        try
        {
            ...
            if ((UpdateBCP(dt)) == true)
            {
                using (CommonData obj = new CommonData())
                {
                    ...
                    DataSet dsResult = obj.BulkUploadExcel("prcBulkAreaUpload");
    ...
    public bool UpdateBCP(DataTable dtUpload)
    {
        try
        {
            ...
            using (SqlBulkCopy bulkCopy = new SqlBulkCopy(PageBase.ConStr, SqlBulkCopyOptions.KeepIdentity))
            {
                ...
                bulkCopy.DestinationTableName = "BulkUploadArea";
                ...
                bulkCopy.ColumnMappings.Add("TehsilName", "TehsilName");
