<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    CodeFile="ManageCityUpload.aspx.cs" Inherits="Masters_Common_ManageCityUpload" %>
        ...
        <div class="formlink">
            <ul>
                ...
                <li class="float-margin" id="dvSaveTemplate">
                    <a class="elink2" href="../../Excel/Templates/UploadCity.xlsx">Download Template</a>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridUpload" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="CityCode"
