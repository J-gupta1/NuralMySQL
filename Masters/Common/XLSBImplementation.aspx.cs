...
public partial class Masters_HO_Common_ManageSKU : PageBase
{
    ...
    public bool insertvalidate()
    {
        ...
        if (Session["SKUCOLORREQD"] != null)
        {
            ...
            {
                if (cmbInsertColor.SelectedValue == "0")
                {
    ...
    protected void exportToExel_Click(object sender, EventArgs e)
    {
        ...
        {
            string[] DsCol = new string[] { "SKU Code", "SKU Name", "SKU Description", "Product Category Name", "Product Name", "Color Name", "Brand Name", "Model Name", "Attribute1", "Attribute2", "Current Status" };
            dt = dt.DefaultView.ToTable(true, DsCol);
        }
        else
        {
            string[] DsCol = new string[] { "SKU Code", "SKU Name", "SKU Description", "Product Category Name", "Product Name", "Color Name", "Brand Name", "Model Name", "Attribute1", "Attribute2", "Carton Size", "Current Status" };
            dt = dt.DefaultView.ToTable(true, DsCol);
        }
        /* #CC02 START END */
