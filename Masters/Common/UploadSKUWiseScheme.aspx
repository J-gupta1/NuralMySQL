<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadSKUWiseScheme.aspx.cs" MasterPageFile="~/CommonMasterPages/MasterPage.master" Inherits="Masters_Common_UploadSKUWiseScheme" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="contentbox" runat="server" id="ForSaveTemplatedownload" visible="false">
        <div class="H25-C3-S">
            ...
            <ul>
                ...
                <li class="link">Note: In StartDate and EndDate Column in Excel  should be  "MM/dd/YYYY" formate.
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="contentbox">
        <div class="H25-C3-S">
            ...
            <ul>
                ...
                <li class="link">
                    <asp:HyperLink ID="hlnkInvalid" runat="server" CssClass="elink3" Visible="true" CausesValidation="false"></asp:HyperLink>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="contentbox">
                <div class="H20-C3-S">
                    <ul>
                        ...
                        <li class="field">
                            <asp:DropDownList ID="ddlSKUCODE" runat="server"
                                CssClass="formselect">
                            </asp:DropDownList>
                        </li>
                        <li class="text">
                        ...
                        <li class="field">
                            <asp:DropDownList ID="ddlRegion" runat="server" CssClass="formselect" AutoPostBack="True">
                            </asp:DropDownList>
                        </li>
                        <li class="text">
                        ...
                        <li class="field">
                            <asp:DropDownList ID="ddlState" runat="server" CssClass="formselect" OnSelectedIndexChanged="ddlState_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList>
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li class="text">Start Date:
                        </li>
                        <li class="field">
                            <uc4:ucDatePicker ID="ucStartDate" ErrorMessage="Invalid Start date."
                                runat="server" />
                        </li>
                        <li class="text">End Date:
                        </li>
                        <li class="field">
                            <uc4:ucDatePicker ID="UcEndDate" ErrorMessage="Invalid End date."
                                runat="server" />
                        </li>
                        ...
                        <li class="field">
                            <div class="float-margin">
                                <asp:Button ID="btnSearch" Text="Search" runat="server" OnClick="btnSearch_Click" CausesValidation="false"
                                    CssClass="buttonbg" />
                            </div>
    ...
    <asp:Panel ID="PnlGrid" Visible="false" runat="server">
        ...
        <div class="contentbox">
            <div class="grid">
                <asp:GridView ID="gvSKUSchemeDetail" runat="server" EmptyDataText="No Record Found" AlternatingRowStyle-CssClass="Altrow"
                    bgcolor="" BorderWidth="0px" DataKeyNames="SKUSchemeId" CellPadding="4" CellSpacing="1" FooterStyle-CssClass="gridfooter"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SKUDescription" HeaderStyle-HorizontalAlign="Left" HeaderText="SKU Description"
                            HtmlEncode="true">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="SchemeDescription" HeaderStyle-HorizontalAlign="Left" HeaderText="Scheme Description"
                            HtmlEncode="true">
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
