<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CommonMasterPages/MasterPage.master" CodeFile="ManageDistrictUpload.aspx.cs"
    Inherits="Masters_Common_ManageDistrictUpload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="contentbox">
        ...
        <div class="formlink">
            <ul>
                <li class="float-margin" id="dvSaveTemplate">
                    <a class="elink2" href="../../Excel/Templates/DistrictUpload.xlsx">Download Template</a>
                </li>
                <li class="float-margin" id="dvUpdateTemplate">
                                        ...
                                        <asp:UpdatePanel ID="updGrid" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridUpload" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="DistrictName"
                                                            HeaderText="District Name">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        
                                                        <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="DistrictCode"
