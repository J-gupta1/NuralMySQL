<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ManageZone.aspx.cs" Inherits="Masters_Common_ManageZone" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
    ...
    <div class="contentbox">
        ...
        <div class="H25-C3-S">
            <ul>
                ...
                <li class="field">
                    <asp:DropDownList ID="ddlCountryName" CssClass="formselect" runat="server"></asp:DropDownList>
                ...
                <li class="field">
                    <asp:TextBox ID="txtInsertZoneName" runat="server" CssClass="formfields" MaxLength="70"></asp:TextBox>
                    <asp:RequiredFieldValidator runat="server" ID="valzname" ControlToValidate="txtInsertZoneName" Display="Dynamic"
                        CssClass="error" ErrorMessage="Please insert Zone Name " ValidationGroup="insert" />
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" TargetControlID="txtInsertZoneName"
    ...
    <div class="contentbox">
        ...
        <div class="H20-C3-S">
            <ul>
                ...
                <li class="text">
                    <asp:Label ID="lblstatefnzonename" runat="server" Text="Zone Name:"></asp:Label>
                </li>
                <li class="field">
                    <asp:TextBox ID="txtSerzoneName" runat="server" CssClass="formfields"></asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" TargetControlID="txtSerzoneName"
                        InvalidChars="<>!@#$%^&*(){}" FilterType="Custom" FilterMode="InvalidChars">
                    </cc1:FilteredTextBoxExtender>
                </li>
                <li class="text">
    ...
    <div id="Zonegrid" runat="server">
        <div class="mainheading">
            Zone List
        </div>
        <div class="export">
            <asp:Button ID="btnExprtToExcel"
                Text="" runat="server" CssClass="excel"
                OnClick="btnExprtToExcel_Click" CausesValidation="False" />
        </div>
    </div>
    <div class="contentbox" id="gridid" runat="server">
        <div class="grid1">
            <%-- <asp:UpdatePanel runat="server" ID="updgrid" UpdateMode="Conditional">
                                        <ContentTemplate>--%>
            <asp:GridView ID="grdzone" runat="server" AllowPaging="false" AlternatingRowStyle-CssClass="Altrow"
                AutoGenerateColumns="false" BorderWidth="0px" CellPadding="4" CellSpacing="1"
                DataKeyNames="ZoneID" FooterStyle-CssClass="gridfooter" FooterStyle-HorizontalAlign="Left"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ZoneName" HeaderText="Zone" HeaderStyle-HorizontalAlign="Left" />
                    ...
                    <asp:TemplateField HeaderText="Status" ItemStyle-Width="85px">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton ID="imgStatus" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ZoneID") %>'
                    ...
                    <asp:TemplateField HeaderText="Edit" ItemStyle-Width="85px">
                        ...
                        <HeaderStyle HorizontalAlign="left" Width="85px" Wrap="False" />
                        <ItemTemplate>
                            <asp:ImageButton ID="img1" runat="server" CausesValidation="false" CommandArgument='<%#Eval("ZoneID") %>'
