    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("[id$=btnSearch]").click(function () {
                if ($("#ctl00_contentHolderMain_cmbPriceList").val() == "0"
                 && $("#ctl00_contentHolderMain_cmbSKUName").val() == "0" &&
                ...
                if ($("[id$=ctl00_contentHolderMain_ucDateFrom_txtDate]").val() != '' && $("[id$=ctl00_contentHolderMain_ucDateTo_txtDate]").val() != '') {

                    var datefrom = new Date($("[id$=ctl00_contentHolderMain_ucDateFrom_txtDate]").val());
                    var dateto = new Date($("[id$=ctl00_contentHolderMain_ucDateTo_txtDate]").val());
            ...
            function Reset() {
                ...
                $("[id$=ctl00_contentHolderMain_ucDateFrom_txtDate]").val('');
                $("[id$=ctl00_contentHolderMain_ucDateTo_txtDate]").val('');
                $("#ctl00_contentHolderMain_cmbPriceList").val('0');
                $("#ctl00_contentHolderMain_cmbSKUName").val('0');
            }
        ...
        function BindGrid(pageIndex) {
            $.ajax({
                ...
                data: '{PageIndex:  ' + parseInt(pageIndex) + ',PageSize: 10,PriceList: ' + parseInt($("#ctl00_contentHolderMain_cmbPriceList").val()) + ',SKUCode:' + parseInt($("#ctl00_contentHolderMain_cmbSKUName").val()) + ',FromDate:"' + $("#ctl00_contentHolderMain_ucDateFrom_txtDate").val() + '",ToDate:"' + $("#ctl00_contentHolderMain_ucDateTo_txtDate").val() + '"}',
