<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/CommonMasterPages/MasterPage.master" 
     CodeFile="ManageStateUpload.aspx.cs" Inherits="Masters_Common_ManageStateUpload" %>
            ...
            <ul>
                <li>
                    ...
                    <div class="float-margin" id="dvSaveTemplate">
                        <a class="elink2" href="../../Excel/Templates/UploadState.xlsx">Download Template</a>
                    </div>
                    <%-- Add End --%>
                                            ...
                                            <ContentTemplate>
                                                <asp:GridView ID="GridUpload" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="StateCode"
                                                            HeaderText="State Code">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        
                                                         <asp:BoundField HtmlEncode="true" HeaderStyle-HorizontalAlign="Left" DataField="CountryName"
                                                            HeaderText="Country">
                                                            <HeaderStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
