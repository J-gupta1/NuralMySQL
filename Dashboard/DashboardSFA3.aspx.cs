...
public partial class Dashboard_DashboardSFA3 : System.Web.UI.Page
{
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                if (dsResult.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblYesterdayOrderQty.Text = dt.Rows[0]["YesterdayOrderQty"].ToString();
                    lblYesterdayOrderAmount.Text = dt.Rows[0]["YesterdayOrderAmount"].ToString();
                    lblMTDOrderQty.Text = dt.Rows[0]["MTDOrderQty"].ToString();
                    lblMTDOrderAmount.Text = dt.Rows[0]["MTDOrderAmount"].ToString();
                }
            }
        }
    ...
    private void GetUserTravelDistanceListData()
    {
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblYesterdayKm.Text = dt.Rows[0]["YesterdayKm"].ToString();
                    lblMTDKM.Text = dt.Rows[0]["MTDKM"].ToString();
                }
            }
        }
    ...
    private void GetUserTimeSpendInMarketListData()
    {
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblYesterdayTimeSpend.Text = dt.Rows[0]["YesterdayTimeSpend"].ToString();
                    lblMTDTimeSpend.Text = dt.Rows[0]["MTDTimeSpend"].ToString();
                }
                else
                {
    ...
    private void GetUserPropectListData()
    {
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblYesterdayProspect.Text = dt.Rows[0]["YesterdayProspect"].ToString();
                    lblMTDProspect.Text = dt.Rows[0]["MTDProspect"].ToString();
                }
            }
        }
    ...
    private void GetUserAverageTimeListData()
    {
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblYesterdayAverageTime.Text = dt.Rows[0]["YesterdayAverageTime"].ToString();
                    lblMTDAverageTime.Text = dt.Rows[0]["MTDAverageTime"].ToString();
                }
            }
        }
    ...
    private void GetTodayTeamAttandanceListData()
    {
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblOnTime.Text = dt.Rows[0]["OnTime"].ToString();
    ...
    {
        ClsBusinessDashboard objdas = new ClsBusinessDashboard();
        objdas.UserID = BussinessLogic.PageBase.UserId;
        objdas.authKey = "";
        ...
        if (dsResult != null)
        {
            if (dsResult.Tables.Count > 0)
            {
                ...
                {
                    DataTable dt = dsResult.Tables[0];
                    lblSaleQty.Text = dt.Rows[0]["YTDSaleQuantity"].ToString();
                    lblSaleValue.Text = dt.Rows[0]["YTDSaleValue"].ToString();
                    lblMTDSaleQty.Text = dt.Rows[0]["MTDSaleQuantity"].ToString();
                    lblMTDSaleValue.Text = dt.Rows[0]["MTDSaleValue"].ToString();
                }
            }
        }
    ...
    protected void OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            string lblEntityTypeID = (item.FindControl("lblEntityTypeID") as Label).Text;
            string strReferenceTypeId = Cryptography.Crypto.Encrypt(lblEntityTypeID, "testEncrpt").ToString();
            //hrefChieldId
            HtmlAnchor a1 = (HtmlAnchor)e.Item.FindControl("hrefChieldId");
            a1.HRef = "DashboardSFA.aspx?userID=" + strReferenceTypeId;
        }
    }
}