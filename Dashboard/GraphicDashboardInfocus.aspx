...
<%--End Sale Trend - Tertiary  --%>
    ...
    <%--Region wise sale Start --%>
        ...
        function drawRegionWiseSale(AllData) {
            ...
            var options = {
                legend: { position: 'right', width: "100%", alignment: 'start', textStyle: { color: 'black', fontSize: 9 } },
                chartArea: { left: 5, top: 10, width: "85%", height: "85%" },
...
<body>
    ...
    <div class="dash_container">
        <div class="dashboard">
             ...
             <div class="part_3">
              ...
              <div style="display:none" class="part_2">
                <div class="padding">
             ...
             <div class="part_2">
                <div class="padding">                    
                 ...
                 <div class="part_5">
                <div class="padding">
                    <asp:Label ID="Label8" runat="server" CssClass="title" Text="Top 7 Distributors (MTD Secondary+Intermediary)"></asp:Label>
       ...
       <div class="part_10">
            ...
            <div class="part_6" style="display:none" >
                  <div class="part_4">
                <div class="padding">
            ...
            <div class="part_10" style="display:none">
                <div class="padding">
                 ...
                 <div class="part_5"  style="display:none">
                <div class="padding">
                    <asp:Label ID="Label3" runat="server" CssClass="title"  style="display:none" Text="Current Vs Last Month Sale"></asp:Label>
    ...
    <div class="clear"></div>
    <div class="footer">&copy; Zed-Axis Technologies 2018-19. All rights reserved.2</div>
</body>
