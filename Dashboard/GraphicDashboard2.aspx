<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GraphicDashboard2.aspx.cs" Inherits="Dashboard_GraphicDashboard2" EnableViewState="true" %>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <script type="text/javascript">
        ...
        function drawRegionsMap(AllData) {
            //    alert("hello");
            var dataValues = AllData.ItemLists;
      ...
      <%--Target vs Achievement Start --%>
        ...
        function drawTargetAchievement(AllData) {
            //    alert("hello");
            var TargetAchievemetValues = AllData.ItemLists;
        ...
        function drawTopModels(AllData) {
            //    alert("hello");
            var TopModels = AllData.ItemLists;
        ...
        function drawLastDayStock(AllData) {
            //    alert("hello");
            var LastDayStock = AllData.ItemLists;
        ...
        function drawSaleData(AllData) {
            //    alert("hello");
            var AllSaleData = AllData.ItemLists;
        ...
        function drawGetTopDistributor(AllData) {
            //    alert("hello");
            var GetTopDistributor = AllData.ItemLists;
        ...
        function drawGetWODLastMonths(AllData) {
            //    alert("hello");
            var GetWODLastMonths = AllData.ItemLists;
        ...
        function drawGetCurrentVsLastMonthSale(AllData) {
            //    alert("hello");
            var GetCurrentVsLastMonthSale = AllData.ItemLists;
        ...
        function drawGetAllSaleDetail(AllData) {
            //    alert("hello");
            var GetAllSaleDetail = AllData.ItemLists;
        ...
        function drawGetCurrentVsLastYearSale(AllData) {
            //    alert("hello");
            var GetCurrentVsLastYearSale = AllData.ItemLists;
