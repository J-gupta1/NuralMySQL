<%@ Page Title="" Language="C#" MasterPageFile="~/CommonMasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="DashboardSFA2popup.aspx.cs" Inherits="DashboardSFA2popup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolderMain" runat="Server">
                                            ...
                                            <div class="card-header p-0 pt-1 border-bottom-0">
                                               <h2 id="clientName"><i class="fa fa-user" aria-hidden="true"></i><span></span></h2>
                                                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist" style="width: 100%">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" runat="server" id="customtabsthreebusinesstab" data-toggle="pill" href="#custom-tabs-three-business2" role="tab" aria-controls="custom-tabs-three-business" aria-selected="true">Business</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" runat="server" id="customtabsthreeattendancetab" data-toggle="pill" href="#custom-tabs-three-attendance2" role="tab" aria-controls="custom-tabs-three-attendance" aria-selected="false">Attendance and leave</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" runat="server" id="customtabsthreetraveltab" data-toggle="pill" href="#custom-tabs-three-travel2" role="tab" aria-controls="custom-tabs-three-travel" aria-selected="false">Travel and expense</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-three-business2" role="tabpanel" aria-labelledby="customtabsthreebusinesstab" style="opacity:5 !important">
                                                        <div id="customtabsthreebusiness" runat="server">
                                                            <div class="row">
          <div class="col-md-12">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Today: <asp:Label ID="lblbusinessToday" runat="server"></asp:Label> &nbsp;,&nbsp; Yesterday : <asp:Label ID="lblbusinessYesterday" runat="server"></asp:Label> &nbsp;,&nbsp; MTD : <asp:Label ID="lblbusinessMTD" runat="server"></asp:Label></h3>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-6 small-box-main" id="YesterdaySalewidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            ...
                                                                            <p>Qty :  <asp:Label ID="lblSaleQty" runat="server"></asp:Label> </p>
                                                                            <p>Value : <asp:Label ID="lblSaleValue" runat="server"></asp:Label> </p>
                                                                                </div>
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="YesterdayCollectionwidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                             <div class="inner-text">
                                                                            <h2>Yesterday <br/> Collection</h2>
                                                                            <p>Total Value : ₹<asp:Label ID="lblytdcol" runat="server"></asp:Label> </p>
                                                                                 </div>
                                                                             <div class="icon-image">
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="YesterdayOrderwidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            ...
                                                                            <p>Qty :  <asp:Label ID="lblYesterdayOrderQty" runat="server"></asp:Label> </p>
                                                                            <p>Value : ₹<asp:Label ID="lblYesterdayOrderAmount" runat="server"></asp:Label> </p>
                                                                                </div>
                                                                            <div class="icon-image">
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="YesterdayProspectwidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            <div class="inner-text">
                                                                            <h2>Yesterday <br /> Prospect</h2>
                                                                            <p>Count :  <asp:Label ID="lblYesterdayProspect" runat="server"></asp:Label> </p>
                                                                                </div>
                                                                             <div class="icon-image">
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="MTDSalewidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            <div class="inner-text">
                                                                            <h2>MTD Sale</h2>
                                                                             <p>Qty :  <asp:Label ID="lblMTDSaleQty" runat="server"></asp:Label> </p>
                                                                             <p>Value : ₹<asp:Label ID="lblMTDSaleValue" runat="server"></asp:Label> </p>
                                                                                 </div>
                                                                            <div class="icon-image">
                                                                                <img src="../images/sale.jpg" />
                                                                            </div>
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            ...
                                                                            <h2>MTD Collection</h2>
                                                                             <p>Total Value :  ₹<asp:Label ID="lblmtdcol" runat="server"></asp:Label> </p>
                                                                                  </div>
                                                                           <div class="icon-image">
                                                                                <img src="../images/collection.jpg" />
                                                                            </div>
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="MTDOrderwidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                             <div class="inner-text">
                                                                            <h2>MTD Order</h2>
                                                                            <p>Qty :  <asp:Label ID="lblMTDOrderQty" runat="server"></asp:Label> </p>
                                                                            <p>Value : <asp:Label ID="lblMTDOrderAmount" runat="server"></asp:Label> </p>
                                                                                 </div>
                                                                           <div class="icon-image">
                                                                                <img src="../images/order.jpg" />
                                                                            </div>
                                                                ...
                                                                <div class="col-lg-3 col-6 small-box-main" id="MTDProspectwidget" runat="server">
                                                                    ...
                                                                    <div class="small-box">
                                                                        <div class="inner" style="text-align: center">
                                                                            <div class="inner-text">
                                                                            <h2>MTD Prospect</h2>
                                                                            <p>Count : <asp:Label ID="lblMTDProspect" runat="server"></asp:Label></p>
                                                                                </div>
                                                                            <div class="icon-image">
                                                                                <img src="../images/prospect.jpg" />
                                                                            </div>
    ...
    <div class="owl-carousel-popup owl-theme" >
		...
		<div class="item-inner" data-toggle="modal" data-target="#myModal" data-entityTypename="<%# Eval("DisplayName") %>">
...
<h2>Name: <asp:Label ID="lbTeamlDisplayName" runat="server" Text='<%# Eval("DisplayName") %>' /></h2>
<p>QTY: <asp:Label ID="Label11" runat="server" Text='<%# Eval("QTY") %>' /></p>
<p>Sale: <asp:Label ID="Label10" runat="server" Text='<%# Eval("Value", "{0:C}") %>' /></p>
<%--<p>Lead: <asp:Label ID="Label9" runat="server" Text='<%# Eval("ProfileImage") %>' /></p>--%>
	 ...
	 <!----------/// Our Team End ------>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12" id="idBeatPlanDiv" runat="server">
                                                                    ...
                                                                    <asp:RadioButton ID="rbtnRanking" runat="server" Text="Your Ranking" GroupName="PlanGroup"
                                                                        ...
                                                                        OnCheckedChanged="rbtnPlan_CheckedChanged" CssClass="radiobtn" Visible="true" />
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-three-attendance2" role="tabpanel" aria-labelledby="customtabsthreeattendancetab" style="opacity:5 !important">
                                                        <%--<div class="row">
                                                            <div class="col-md-12">
                                                                <div style="text-align: center">
          ...
          <div class="col-md-12">
            ...
            <!-- /.card -->
                                                        ...
                                                        <div class="row" id="attendanceSelf1">
                                                            <div class="col-lg-3 col-6 small-box-main" id="AttendanceMTDwidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-1">
                                                                    ...
                                                                    <p>Present: <asp:Label ID="lblPresentDays" runat="server"></asp:Label></p>
                                                                     <p>Absent: <asp:Label ID="lblAbsentDays" runat="server"></asp:Label></p>
                                                                        </div>
                                                                        <div class="icon-image">
                                                            ...
                                                            <div class="col-lg-3 col-6 small-box-main" id="TodayAttendancewidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-2">
                                                                    <div class="inner" style="text-align: center">
                                                                        <div class="inner-text">
                                                                        <h2>Today <br /> Attendance</h2>
                                                                          <p id="ontime" runat="server">On Time: <asp:Label ID="lblOnTime" runat="server"></asp:Label></p>
                                                                     <p id="late" runat="server">Late: <asp:Label ID="lblLateChecking" runat="server"></asp:Label></p>
                                                                            <p id="leave" runat="server">Leave: <asp:Label ID="lblLeave" runat="server"></asp:Label></p>
                                                                            <p id="nocheck" runat="server">No Checkin: <asp:Label ID="lblNotChecking" runat="server"></asp:Label></p>
                                                                        </div>
                                                                        <div class="icon-image">
                                                            ...
                                                            <div class="col-lg-3 col-6 small-box-main" id="leaveMTDwidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-3" style="text-align: center">
                                                                    <div class="inner" style="text-align: center">
                                                                    <div class="inner-text">
                                                                    <h2>Leave MTD <br /> (Application/ <br />Amount)</h2>
                                                                        <p>Approved: <asp:Label ID="Label7" runat="server"></asp:Label></p>
                                                                        <p>Pending: <asp:Label ID="lblLeavePending" runat="server"></asp:Label></p>
                                                                        <p>Rejected: <asp:Label ID="lblLeaveRejected" runat="server"></asp:Label></p>
                                                                        </div>
                                                                    <div class="icon-image">
                                                                                    ...
                                                                                    <thead>
                                                                                        <tr>
                                                                                           <th style="width:25%">User Name</th>
                                                                                            <th style="width:30%">Approved <asp:Label ID="lbl" runat="server" ForeColor="Gray" style="font-size: medium;">(Application/Approved Days)</asp:Label></th>
                                                                                            <th style="width:30%">Pending<br /> <asp:Label ID="Label1" runat="server" ForeColor="Gray" style="font-size: medium;">(Application/Pending Days)</asp:Label></th>
                                                                                            <th style="width:35%">Rejected <asp:Label ID="Label2" runat="server" ForeColor="Gray" style="font-size: medium;">(Application/Rejected Days)</asp:Label></th>
                                                                                        </tr>
                                                                                    </thead>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:Label ID="lblAttendanceOnTime" runat="server" Text='<%# Eval("OnTime").ToString()=="No"?"--":"Yes" %>' />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Label ID="lblAttendanceLateChecking" runat="server" Text='<%# Eval("LateChecking").ToString()=="No"?"--":"Yes" %>' />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Label ID="lblAttendanceLeave" runat="server" Text='<%# Eval("Leave").ToString()=="No"?"--":"Yes" %>' />
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Label ID="lblAttendanceNotChecking" runat="server" Text='<%# Eval("NotChecking").ToString()=="No"?"--":"Yes" %>' />
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </ItemTemplate>
...
<%--	      <li><img src="../images/pdf-icon.jpg"></li>
		  <li><img src="../images/excel-icon.jpg"></li>--%>
                                                    ...
                                                    <div class="tab-pane fade" id="custom-tabs-three-travel2" role="tabpanel" aria-labelledby="custom-tabs-three-travel-tab" style="opacity:5 !important">
                                                       <%-- <div style="text-align: center">
                                                        ...
                                                        <div class="row" id="travelSelf">
                                                            <div class="col-lg-3 col-6 small-box-main" id="DistanceTravelwidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-1">
                                                                    ...
                                                                    <h2>Distance Travel</h2>
                                                                     <p>Yesterday: <asp:Label ID="lblYesterdayKm" runat="server"></asp:Label></p>
                                                                     <p>MTD: <asp:Label ID="lblMTDKM" runat="server"></asp:Label></p>
                                                                            </div>
                                                                        <div class="icon-image">
                                                            ...
                                                            <div class="col-lg-3 col-6 small-box-main" id="TimespendMarketwidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-2">
                                                                    <div class="inner" style="text-align: center">
                                                                         <div class="inner-text">
                                                                        <h2>Time spend in <br /> Market</h2>
 <p>Yesterday: <asp:Label ID="lblYesterdayTimeSpend" runat="server"></asp:Label></p>
                                                                     <p>MTD: <asp:Label ID="lblMTDTimeSpend" runat="server"></asp:Label></p>
                                                                        </div>
                                                                        <div class="icon-image">
                                                            ...
                                                            <div class="col-lg-3 col-6 small-box-main" id="Expensewidget" runat="server">
                                                                ...
                                                                <div class="small-box small-box-bg-3" style="text-align: center">
                                                                    <div class="inner" style="text-align: center">
                                                                    <div class="inner-text">
                                                                    <h2>Expense <br />(Application/ <br />Amount)</h2>
                                                                    <p>Approved : <asp:Label ID="lblExpenseApproved" runat="server"></asp:Label></p>
                                                                            <p>Pending:<asp:Label ID="lblExpensePending" runat="server"></asp:Label> </p>
                                                                            <p>Rejected: <asp:Label ID="lblExpenseRejected" runat="server"></asp:Label></p>
                                                                     </div>
                                                                        <div class="icon-image">
...
<%--	      <li><img src="../images/pdf-icon.jpg"></li>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#contentHolderMain_rbtnDistributors').click(function () {

                if ($(this).is(":checked") == true) {
                    $('div').removeClass('active-tab-table');

                    $('#idDistributorsDiv').addClass('active-tab-table');
                }

            });


            $('#contentHolderMain_rbtnRetailer').click(function () {
