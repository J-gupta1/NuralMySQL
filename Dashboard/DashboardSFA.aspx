<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSFA.aspx.cs" Inherits="Dashboard_DashboardSFA" %>
                                                                    ...
                                                                    <div class="card card-info">
                                                                        <div class="card-header">
                                                                            <h3 class="card-title">Yesterday =
                                                                                ...
                                                                                &nbsp;,&nbsp; Today=
                                                                                <asp:Label ID="lblbusinessToday" runat="server"></asp:Label>&nbsp;,&nbsp;  MTD =
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <a id="hrefChieldId" runat="server">
                                                                                                            <div class="col-12">
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    Value:
                                                                                                                    <asp:Label ID="lblValue" runat="server" Text='<%# Eval("Value" , "{0:C}") %>' />
                                                                                                                </div>
                                                                                                            </div>
                                                                ...
                                                                <div class="card card-info">
                                                                    <div class="card-header">
                                                                        <h3 class="card-title">Yesterday =
                                                                            ...
                                                                            &nbsp;,&nbsp; Today=
                                                                            <asp:Label ID="lblattendanceToday" runat="server"></asp:Label>&nbsp;,&nbsp;  MTD =
                                                                ...
                                                                <div class="card card-info">
                                                                    <div class="card-header">
                                                                        <h3 class="card-title">Yesterday =
                                                                            ...
                                                                            &nbsp;,&nbsp; Today=
                                                                            <asp:Label ID="lbltravelToday" runat="server"></asp:Label>&nbsp;,&nbsp;  MTD =
